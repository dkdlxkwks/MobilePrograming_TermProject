...
public class DBHelper_Exercise extends SQLiteOpenHelper {
    ...
    public DBHelper_Exercise(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public void insert(String name, long time) {
        ...
        // DB에 입력한 값으로 행 추가
        db.execSQL("INSERT INTO EXERCISE VALUES(null, '" + name + "', " + time +");");
        db.close();
    }
    ...
    public void update(String title, String content) {
        ...
        db.execSQL("UPDATE EXERCISE SET price=" + title + " WHERE item='" + content + "';");
        db.close();
    }
    ...
    public void delete(String title) {
        SQLiteDatabase db = getWritableDatabase();
        // 입력한 항목과 일치하는 행 삭제
        db.execSQL("DELETE FROM EXERCISE WHERE item='" + title + "';");
        db.close();
    }
